<div class="alert alert-{{ (count(Auth::user()->unreadNotifications) != 0) ? 'success' : 'secondary' }} alert-dismissible fade show" role="alert">
    ...
    <p> Hi, Laporan anda dengan judul <i>{{ $notification->data['report']['title'] }}</i> telah selesai dilakukan Investigasi. Terima kasih atas partisipasi anda dalam upaya penegakan hukum atas pelanggaran yang terjadi di lingkungan Politeknik Negeri Batam.
    </p>
